...
$(function(){
    ...
    let openSmartFilter = function(event){
        ...
        if(!openSmartFilterFlag){
            $("#smartFilter").addClass("opened").css('marginTop', ($('.oSmartFilter').offset().top - $('#nextSection').offset().top - $('#nextSection').height() +40));
        ...
        for (let i in arItem.VALUES)
        {
            if (arItem.VALUES.hasOwnProperty(i))
            {
                ...
                if (!!control)
                {
                    ...
                    let input = document.getElementById(value.CONTROL_ID);
...
JCSmartFilter.prototype.postHandler = function (result, fromCache)
{
    ...
    let set_filter_num = BX("set_filter_num");
...
JCSmartFilter.prototype.hideFilterProps = function(element)
{
    ...
    else
    {
        ...
        let obj_children_height = filterBlock.offsetHeight;
...
JCSmartFilter.prototype.selectDropDownItem = function(element, controlId)
{
    ...
    let wrapContainer = BX.findParent(BX(controlId), {className:"bx-filter-select-container"}, false);
...
{
    let SmartFilter = function(arParams)
    {
    ...
    SmartFilter.prototype.setMinFilteredValue = function (fltMinPrice)
    {
        ...
        {
            let priceDiff = this.fltMinPrice - this.minPrice;
    ...
    SmartFilter.prototype.setMaxFilteredValue = function (fltMaxPrice)
    {
        ...
        {
            let priceDiff = this.maxPrice - this.fltMaxPrice;
    ...
    SmartFilter.prototype.countNewLeft = function(event)
    {
        ...
        let trackerXCoord = this.getXCoord(this.trackerWrap);
        let rightEdge = this.trackerWrap.offsetWidth;
...
let openDropdownList = function(e) {
...
let closeList = function(event) {
    $("#smartFilter .dropdownList").removeClass("opened");
};

let showHint = function(event) {
    $(this).find(".hintValue").toggle();
    event.stopImmediatePropagation();
};

let closeHint = function(event) {
    $(".hintValue").hide();
...
let showAllParams = function(e) {
    let $this = $(this);
    let $elements = $this.parents("li").siblings("li");
...
$(window).on("load", function() {
    ...
    let $filterEl = $("#smartFilter input");
    let $filter = $("#smartFilterForm");
    let $modef = $("#modef");

    $filterEl.on("change", function() {
        let $this = $(this);
        let _itemOffset = $this.offset().top - $this.height() / 2;
    ...
    $(".paramsBoxTitle span").on("click", function(){
        let $this = $(this).parents(".paramsBoxTitle");
